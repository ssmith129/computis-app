...
import { MoreHorizontal, TrendingUp, TrendingDown, AlertTriangle, CheckCircle, Clock, Users, FileText, Settings, DollarSign, Activity, ArrowUpRight } from "lucide-react";
...
interface EnhancedDashboardCardProps {
  ...
  iconBg: string;
  chartData?: number[];
  chartColor?: "blue" | "green" | "orange" | "yellow" | "cyan" | "red" | "purple";
  progress?: number;
      ...
      <CardContent className="p-6">
        <div className="flex items-start justify-between mb-4">
          <div className="flex items-center gap-3">
            <div className={`p-3 rounded-xl ${iconBg} transition-transform duration-300 ${isHovered ? 'scale-110' : ''}`}>
        ...
        <div className="space-y-3">
          <div className="flex items-end justify-between">
            <div className="space-y-1">
              <div className={`text-3xl font-bold text-gray-900 transition-all duration-300 ${animate && isHovered ? 'scale-105' : ''}`}>
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-lg font-bold text-gray-900">Key Metrics & Tools</h2>
          <p className="text-sm text-gray-500">Overview of your crypto tax preparation status</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
        <Card className="p-6 bg-gradient-to-r from-blue-50 to-indigo-50 border-blue-200 hover:shadow-lg transition-all duration-300">
          <CardContent className="p-0">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="font-semibold text-gray-900 mb-2">Ready to File?</h3>
                <p className="text-sm text-gray-600 mb-4">All transactions classified and forms generated</p>
                <Link to="/exports">
          ...
          <CardContent className="p-0">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-600 mb-4">Import transactions from wallets and exchanges</p>
